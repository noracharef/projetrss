        ...
        <div class="modal-body">
          <form action="index.php" method="post">
            ...
            <div>
              ...
              <div class="text-center my-3">
                <input type="radio" class="form-check-input ms-3" name="nbArticle" id="article5" value="5" <?php if (!isset($_COOKIE["nbArticle"]) ||(isset($_COOKIE["nbArticle"]) && $_COOKIE["nbArticle"] == "5")) { ?> checked <?php } ?>>
